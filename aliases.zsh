...
alias gpaw='cd ~/Documents/Riverlane/gpaw-avi'
alias fowl='cd ~/Documents/Riverlane/fowler_formula/'
alias latpr='cd ~/Documents/Riverlane/latex_projects/'
alias cx='cd ~/Documents/Riverlane/code_explorer/'
alias py='python3.13'
